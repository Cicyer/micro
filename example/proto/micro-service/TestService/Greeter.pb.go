...
// UnimplementedOrder2ServiceServer can be embedded to have forward compatible implementations.
...
func RegisterOrder2ServiceServer(s *grpc.Server, srv Order2ServiceServer) {
	s.RegisterService(&_Order2Service_serviceDesc, srv)
}
...
var _Order2Service_serviceDesc = grpc.ServiceDesc{
